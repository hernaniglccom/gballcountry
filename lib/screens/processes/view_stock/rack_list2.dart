...
class RackList2 extends StatefulWidget {
  const RackList2({Key? key}) : super(key: key);

  @override
  State<RackList2> createState() => _RackList2State();
}

class _RackList2State extends State<RackList2> {
